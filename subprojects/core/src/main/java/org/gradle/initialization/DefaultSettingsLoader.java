...
public class DefaultSettingsLoader implements SettingsLoader {
    ...
    private void deprecateWarningIfNecessary(StartParameter startParameter, SettingsInternal settings) {
        ...
        DeprecationLogger.nagUserWith("Support for nested build without a 'settings.gradle' was deprecated and will be removed in Gradle 5.0. You should create a empty settings.gradle in " + projectDir.getAbsolutePath());
    }
